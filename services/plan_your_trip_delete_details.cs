...
{
    public class plan_your_trip_delete_details
    {
        dbServices ds = new dbServices();
       public async Task<responseData> Plan_your_trip_delete_details(requestData rData)
{
    responseData resData = new responseData();
     ...
     try
            {
                // Your delete query
                var query = @"DELETE FROM detailsdb.details WHERE id = @Id;";
